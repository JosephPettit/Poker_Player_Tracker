...
public class PostFlopTabController implements Initializable {

    public TableView<PlayerDisplayData> postFlopTable;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        all_in.setCellValueFactory(new PropertyValueFactory<>("PostFlopAll_in"));

        postFlopTable.setItems(MainController.getPlayerList());
